...
val generateTask = tasks.named<GenerateTask>("openApiGenerate") {
    ...
    doLast {
        delete("${generatedProjectDir}/src/main/java/org/sample/webflux/api/TestApiController.java")
        delete("${generatedProjectDir}/src/main/java/org/sample/webflux/api/ApiUtil.java")
        delete("${generatedProjectDir}/src/main/java/org/sample/webflux/OpenApiGeneratorApplication.java")
        delete("${generatedProjectDir}/src/main/java/org/sample/webflux/RFC3339DateFormat.java")
