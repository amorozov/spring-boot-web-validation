...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2021-12-05T22:54:13.319351+07:00[Asia/Novosibirsk]")
@Validated
...
public interface TestApi {
     ...
     */
    @ApiOperation(value = "a sample POST request with a mandatory Request Body", nickname = "testBodyVerification", notes = "", tags = {})
    @ApiResponses(value = {
    ...
    Mono<ResponseEntity<Void>> testBodyVerification(
            @ApiParam(value = "sample POST request body", required = true)
            @Valid @RequestBody
                    Mono<TestRequestBody> testRequestBody,
     ...
     * @return OK (status code 204)
     */
    @ApiOperation(value = "a sample GET request with input passed as parameters", nickname = "testParametersVerification", notes = "", tags = {})
    @ApiResponses(value = {
            @ApiResponse(code = 204, message = "OK")})
    @RequestMapping(
    ...
    Mono<ResponseEntity<Void>> testParametersVerification(
